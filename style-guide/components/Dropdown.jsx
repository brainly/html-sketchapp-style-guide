...
const DropdownsPage = () => {
  ...
  [false, true].forEach(opened => {
    const name = `Dropdown/${opened ? 'opened' : 'closed'}`;

    const containerClassName = opened
      ? 'sg-dropdown sg-dropdown--full-width sg-dropdown--opened'
      : 'sg-dropdown sg-dropdown--full-width';
            ...
            {opened ? (
              ...
              >
                <g transform="translate(-82.000000, -12.000000)" fill="#9FA6B5">
                  <polygon
                    transform="translate(86.000000, 15.000000) scale(1, -1) translate(-86.000000, -15.000000) "
                    points="86 12 90 18 82 18"
                  ></polygon>
                </g>
              </svg>
            )}
